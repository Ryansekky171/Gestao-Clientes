...
<body class="min-h-screen flex items-center justify-center bg-gray-50 text-gray-800">
    ...
    <div class="w-full max-w-3xl mx-auto flex bg-white rounded-2xl shadow-lg overflow-hidden">
        <div class="w-full md:w-1/2 p-8">
            <h1 class="text-3xl font-bold text-gray-800 mb-2">Esqueceu a Senha?</h1>
            <p class="text-gray-600 mb-6">Insira seu e-mail para receber o link de redefinição.</p>
            @if (session('status'))
                <div class="bg-green-100 text-green-700 px-4 py-3 rounded mb-4 border border-green-200 text-sm">
                    {{ session('status') }}
                </div>
            @endif
            ...
            <div class="mt-6 text-center text-sm">
                <p class="text-gray-600">Lembrou da senha?
        ...
        <div
            ...
            <div class="text-center text-white px-6">
                <h2 class="text-4xl font-bold mb-2">Recuperação</h2>
                <p class="text-lg opacity-90">Siga as instruções enviadas para o seu e-mail para redefinir sua senha.
                </p>
            </div>
        </div>
    </div>
