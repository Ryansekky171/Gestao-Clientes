...
<head>
  ...
  <title>Registro - Gestão de Clientes</title>
...
<body class="min-h-screen flex items-center justify-center bg-gray-50 text-gray-800">
  ...
  <div class="w-full max-w-3xl mx-auto flex bg-white rounded-2xl shadow-lg overflow-hidden">
    <div class="w-full md:w-1/2 p-8">
      ...
      <p class="text-gray-600 mb-6">Junte-se a nós para começar a gerenciar seus dados!</p>
    ...
    <div
      ...
      <div class="text-center text-white px-6">
        <h2 class="text-4xl font-bold mb-2">Bem-vindo!</h2>
        <p class="text-lg opacity-90">Crie sua conta para acessar o sistema de gestão.</p>
      </div>
    </div>
  </div>
</body>
