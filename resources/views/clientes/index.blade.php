    ...
    @else
        <div class="mb-6">
            <div class="relative flex-grow max-w-lg">
                <input type="text" id="search-name" placeholder="Buscar por Nome (mínimo 3 caracteres)"
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-indigo-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-semibold text-indigo-700 uppercase tracking-wider">Email
                        </th>
                        <th class="px-6 py-3 text-left text-xs font-semibold text-indigo-700 uppercase tracking-wider">Telefone
                        </th>
                        <th class="px-6 py-3 text-left text-xs font-semibold text-indigo-700 uppercase tracking-wider">CPF/CNPJ
                        </th>
